...
public class VideoCallActivity extends Activity implements AnyChatBaseEvent {
	...
	private void updateUserList() {
		...
		mAdapter = new RoleListAdapter(VideoCallActivity.this, mRoleInfoList);
		...
		mRoleList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == 0) {
					...
					intent.setClass(VideoCallActivity.this, VideoConfig.class);
	...
	private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals("VideoActivity")) {
				Toast.makeText(VideoCallActivity.this, "网络已断开！", Toast.LENGTH_SHORT)
						.show();
				setBtnVisible(SHOWLOGINSTATEFLAG);
				mRoleList.setAdapter(null);
				mBottomConnMsg.setText("No content to the server");
