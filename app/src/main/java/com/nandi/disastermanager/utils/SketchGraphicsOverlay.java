...
public class SketchGraphicsOverlay {
    ...
    private final SceneView mMapView;
     ...
     */
    public SketchGraphicsOverlay(TextView textView, SceneView mapView, SketchGraphicsOverlayEventListener listener) {
        mMapView = mapView;
        mListener = listener;
        ...
        mMapView.setOnTouchListener(new DrawingMapViewOnTouchListener(mMapView));
        Log.d("----------","执行了构造方法");
     ...
     */
    private class DrawingMapViewOnTouchListener extends DefaultSceneViewOnTouchListener {
         ...
         */
        public DrawingMapViewOnTouchListener( SceneView mapView) {
            super( mapView);
        }

        @Override
        public boolean onSingleTapConfirmed(MotionEvent event) {
            Log.d("---------","执行了onSingleTapConfirmed()方法");
                    ...
                    try {
                        ...
                        if (!graphic.isEmpty()&&mDrawingMode== DrawingMode.NONE){
                            ...
                            if (geometry instanceof Polyline){
                                ...
                                textView.setText("长度为:"+length+"千米");
                                ...
                                textView.setText("面积为:"+area+"平方千米");
                            }
                        }
                        ...
                        if (!graphic.isEmpty() && !(graphic.get(0).getGeometry() instanceof Polygon)) {
                            ...
                            Point point = mMapView.screenToLocationAsync(screenPoint).get();
        ...
        public boolean onScroll(MotionEvent from, MotionEvent to, float distanceX, float distanceY) {
            ...
            if (mCurrentPoint != null) {
                ...
                LocationToScreenResult locationToScreenResult = mMapView.locationToScreen((Point) mCurrentPoint.getGeometry());
                ...
                if (distance < 20) {
                    ...
                    try {
                        newGeometry = mMapView.screenToLocationAsync(toPoint).get();
